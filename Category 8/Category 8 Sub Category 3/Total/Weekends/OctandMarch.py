...
OR3_lavatory_ExhaustFan1.windows([0,1440],[0,0],0.1)
OR3_lavatory_Tubelights1 = OR3.Appliance(OR3,2,55,2,60,0.2,5, occasional_use = 0.2)
OR3_lavatory_Tubelights1.windows([0,1440],[0,0],0.1)
...
OR3_Phone_charger = OR3.Appliance(OR,4,5,2,180,0.3,15)
...
OR1_lavatory_ExhaustFan.windows([0,1440],[0,0],0.1)
...
OR1_BathroomGeyser = OR1.Appliance(OR1,1,2000,2,90,0.1,15, 'yes',1,occasional_use=0.5)
...
OR2_lavatory_Tubelights.windows([0,1440],[0,0],0.1)
