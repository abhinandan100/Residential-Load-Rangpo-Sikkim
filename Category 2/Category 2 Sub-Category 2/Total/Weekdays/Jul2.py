...
OR_WaterPurifier.windows([1320,1380],[480,780],0.3)
...
OR4_Fan = OR4.Appliance(OR4,2,70, 2, 720,0.15)
OR4_Fan.windows([1290,1440],[0,840],0.2)
OR4_Fan1 = OR4.Appliance(OR4,1,70, 2, 360,0.15,15,occasional_use=0.5)
OR4_Fan1.windows([1290,1440],[0,840],0.2)
...
OR4_WaterPurifier.windows([480,780],[1320,1440],0.3)
...
OR1_Fan = OR1.Appliance(OR1,2,70, 2, 720,0.15)
OR1_Fan.windows([1290,1440],[0,840],0.2)
OR1_Fan1 = OR1.Appliance(OR1,1,70, 2, 360,0.15,15,occasional_use=0.5)
OR1_Fan1.windows([1290,1440],[0,840],0.2)
...
OR1_WaterPurifier.windows([420,780],[0,0],0.3)
...
OR2_Fan.windows([1290,1440],[0,840],0.2)
OR2_Fan1 = OR2.Appliance(OR2,1,70, 2, 360,0.15,15,occasional_use=0.5)
OR2_Fan1.windows([1290,1440],[0,840],0.2)
...
OR2_WaterPurifier.windows([480,780],[0,0],0.3)
...
OR3_Fan.windows([1290,1440],[0,840],0.2)
OR3_Fan1 = OR3.Appliance(OR3,1,70, 2, 360,0.15,15,occasional_use=0.5)
OR3_Fan1.windows([1290,1440],[0,840],0.2)
...
OR3_MosquitoRepellent.windows([480,780],[1290,1350],0.35)
