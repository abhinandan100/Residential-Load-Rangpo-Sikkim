...
OR_Fan = OR.Appliance(OR,1,70,2,120,0.15,15)
...
OR1_Fan1 = OR1.Appliance(OR1,1,70, 2, 780,0.15,15,occasional_use=0.5)
...
OR2_Fan = OR2.Appliance(OR2,1,70,2,120,0.15,15)
OR2_Fan.windows([360,1260],[0,0],0.3)
OR2_Fan1 = OR2.Appliance(OR2,1,70,2,120,0.15,15,occasional_use = 0.5)
OR2_Fan1.windows([360,1260],[0,0],0.3)
...
OR3_Fan = OR3.Appliance(OR3,1,70,2,120,0.15,15)
...
OR4_Fan = OR4.Appliance(OR4,1,70,2,120,0.15,15)
OR4_Fan.windows([360,1260],[0,0],0.3)
OR4_Fan1 = OR4.Appliance(OR4,1,70,2,120,0.15,15,occasional_use = 0.5)
OR4_Fan1.windows([360,1260],[0,0],0.3)
