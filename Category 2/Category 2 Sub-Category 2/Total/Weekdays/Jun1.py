...
OR_Iron.windows([1080,1320],[240,360],0.3)
OR_laptop = OR.Appliance(OR,1,50,2,60,0.15,30,occasional_use = 0.33)
OR_laptop.windows([1080,1440],[240,360],0.1)
...
OR_WaterPump.windows([900,1080],[0,0],0.3)
...
OR1_Fan.windows([870,1440],[0,360],0.2)
OR1_Fan1 = OR1.Appliance(OR1,1,70, 2, 360,0.15,15,occasional_use=0.5)
OR1_Fan1.windows([870,1320],[0,0],0.2)
...
OR1_TV=OR1.Appliance(OR1,2,60,2,180,0.2,30)
...
OR1_laptop = OR1.Appliance(OR1,1,50,2,60,0.15,30,occasional_use = 0.33)
OR1_laptop.windows([1080,1440],[240,360],0.1)
OR1_hairtrimmercharger = OR1.Appliance(OR1,1,5,2,30,0.15,15,occasional_use = 0.2)
OR1_hairtrimmercharger.windows([900,1080],[0,0],0.1)
...
OR1_VacuumCleaner.windows([900,960],[0,0], 0.15)
...
OR1_MusicSystem.windows([900,1260],[0,0],0.3)
...
OR1_WaterPump = OR1.Appliance(OR1,1,500,2,30,0.15,15, occasional_use=0.5)
OR1_WaterPump.windows([900,1080],[0,0],0.3)
...
OR2_indoor_Tubelight2 = OR2.Appliance(OR2,1,55,2,360,0.15,15, occasional_use = 0.5)
OR2_indoor_Tubelight2.windows([1020,1320],[240,360],0.3)
OR2_indoor_Tubelight3 = OR2.Appliance(OR2,1,55,2,360,0.15,1)
OR2_indoor_Tubelight3.windows([1020,1320],[240,360],0.1)
OR2_indoor_Tubelight4 = OR2.Appliance(OR2,1,55,2,120,0.15,15, occasional_use = 0.5)
OR2_indoor_Tubelight4.windows([1020,1320],[300,360],0.3)
OR2_Fan = OR2.Appliance(OR2,2,70, 2, 720,0.15)
OR2_Fan.windows([870,1440],[0,360],0.2)
OR2_Fan1 = OR2.Appliance(OR2,1,70, 2, 360,0.15,15,occasional_use=0.5)
OR2_Fan1.windows([870,1320],[0,0],0.2)
...
OR2_TV=OR2.Appliance(OR2,2,60,2,180,0.2,30)
...
OR2_KitchenTubelight.windows([1140,1320],[240,360],0.2)
...
OR2_MixerGrinder.windows([1080,1320],[0,0],0.3)
...
OR2_Iron.windows([1080,1320],[0,0],0.3)
...
OR3_indoor_Tubelight2 = OR3.Appliance(OR3,2,55,2,360,0.15,15, occasional_use = 0.5)
OR3_indoor_Tubelight2.windows([1020,1320],[240,360],0.3)
OR3_Fan = OR3.Appliance(OR3,2,70, 2, 720,0.15)
OR3_Fan.windows([870,1440],[0,360],0.2)
OR3_Fan1 = OR3.Appliance(OR3,1,70, 2, 360,0.15,15,occasional_use=0.5)
OR3_Fan1.windows([870,1320],[0,0],0.2)
...
OR3_TV=OR3.Appliance(OR3,2,60,2,180,0.2,30)
...
OR3_KitchenTubelight.windows([1140,1320],[240,360],0.2)
OR3_KitchenExhaustFan=OR3.Appliance(OR3,1,40,2,180,0.15,15)
OR3_KitchenExhaustFan.windows([1140,1380],[240,360],0.2)
...
OR3_WaterPurifier = OR3.Appliance(OR3,1,50,2,60,0.15,15)
OR3_WaterPurifier.windows([870,1320],[240,360],0.3)
OR3_MosquitoRepellent = OR3.Appliance(OR3,1,7,2,480,0.15,30)
OR3_MosquitoRepellent.windows([1200,1440],[0,360],0.35)

#One-Room Minimum Connected Load
#Create new user classes
OR4 = User("One room minimal",4,1)
User_list.append(OR4)

#One-Room Minimum Connected Load
OR4_indoor_LEDBulb1 = OR4.Appliance(OR4,1,55,2,420,0.15,15)
OR4_indoor_LEDBulb1.windows([1020,1320],[240,330],0.1)
OR4_indoor_LEDBulb2 = OR4.Appliance(OR4,1,55,2,360,0.15,15, occasional_use = 0.5)
OR4_indoor_LEDBulb2.windows([1020,1320],[240,360],0.3)
OR4_Fan = OR4.Appliance(OR4,1,70, 2, 720,0.15)
OR4_Fan.windows([870,1440],[0,360],0.2)
OR4_Fan1 = OR4.Appliance(OR4,1,70, 2, 360,0.15,15,occasional_use=0.5)
OR4_Fan1.windows([870,1320],[0,0],0.2)
...
OR4_TV=OR4.Appliance(OR4,1,60,2,180,0.2,30)
OR4_TV.windows([900,1199],[1201,1320], 0.15)
OR4_SetTopBox = OR4.Appliance(OR4,1,10,2,210,0.15,15)
OR4_SetTopBox.windows([900,1199],[1201,1320],0.3)
