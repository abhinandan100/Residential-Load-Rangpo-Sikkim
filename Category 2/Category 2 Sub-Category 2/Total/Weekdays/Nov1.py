...
OR3_BathroomGeyser.windows([900,960],[240,360],0.1)
OR3_BathroomGeyser.specific_cycle_1(2000,10,10,5)
OR3_BathroomGeyser.cycle_behaviour([1080,1140],[240,360])
...
OR4_ImmersionHeater = OR4.Appliance(OR4,1,1000,2,45,0.3,15)
OR4_ImmersionHeater.windows([240,360],[0,0],0.35)
