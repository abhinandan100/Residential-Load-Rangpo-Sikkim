...
OR1_TV=OR1.Appliance(OR1,1,60,2,180,0.25,30,occasional_use = 0.5)
OR1_TV.windows([360,1440],[0,0], 0.15)
OR1_ImmersionHeater = OR1.Appliance(OR1,1,1000,2,45,0.3,15,occasional_use = 0.5)
...
OR3_Phone_charger = OR3.Appliance(OR3,1,5,1,180,0.3,15)
...
OR3_RoomHeater.cycle_behaviour(1080,1440],[0,0])
OR3_BathroomGeyser = OR3.Appliance(OR3,1,2000,2,60,0.1,15, 'yes',1)
OR3_BathroomGeyser.windows([360,900],[0,0],0.1)
OR3_BathroomGeyser.specific_cycle_1(2000,10,10,5)
OR3_BathroomGeyser.cycle_behaviour([360,900],[0,0])
...
OR4_WaterPurifier = OR4.Appliance(OR4,1,60,2,60,0.15,15,occasional_use=0.5)
...
OR4_BathroomGeyser.windows([360,9000],[0,0],0.1)
...
OR5_indoor_Tubelight4 = OR5.Appliance(OR5,1,55,2,120,0.15,15)
...
OR5_balcony_LED = OR5.Appliance(OR5,1,9,2,30,0.15,5, occasional_use = 0.5)
...
OR5_MixerGrinder = OR5.Appliance(OR5,1,500,2,60,0.15,15,occasional_use = 0.5)
...
OR5_RoomHeater = OR5.Appliance(OR5,1,2000,2,240,0.1,30, 'yes',1, occasional_use = 0.5)
OR5_RoomHeater.windows([1080,1440],[0,0],0.1)
OR5_RoomHeater.specific_cycle_1(20,20,2000,10)
OR5_RoomHeater.cycle_behaviour(1080,1440],[0,0])
OR5_BathroomGeyser = OR5.Appliance(OR5,1,2000,2,60,0.1,15, 'yes',1)
OR5_BathroomGeyser.windows([360,900],[0,0],0.1)
OR5_BathroomGeyser.specific_cycle_1(2000,10,10,5)
OR5_BathroomGeyser.cycle_behaviour([360,900],[0,0])
