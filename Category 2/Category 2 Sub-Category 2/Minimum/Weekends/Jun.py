...
OR_Fan = OR.Appliance(OR,1,70, 2, 1260,0.35,15,occasional_use = 0.5)
OR_Fan.windows([360,1440],[0,0],0.35)
OR_Fan1 = OR.Appliance(OR,1,70, 2, 900,0.35,15,occasional_use = 0.5)
OR_Fan1.windows([0,1440],[0,0],0.35)
