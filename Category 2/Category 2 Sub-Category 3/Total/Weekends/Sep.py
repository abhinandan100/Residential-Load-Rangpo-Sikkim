...
OR_Fan1 = OR.Appliance(OR,1,70, 2, 720,0.15,15,occasional_use=0.75)
...
OR_BathroomGeyser.cycle_behaviour([420,900],[1080,1200])
...
OR1_Fan = OR1.Appliance(OR1,1,30, 2, 720,0.15)
OR1_Fan.windows([480,1440],[0,0],0.2)
OR1_Fan1 = OR1.Appliance(OR1,1,30, 2, 720,0.15,15,occasional_use=0.75)
...
OR2_Fan = OR2.Appliance(OR2,1,70, 2, 720,0.15)
...
OR6_Fan1 = OR6.Appliance(OR6,1,70, 2, 720,0.15,15,occasional_use=0.75)
...
OR7_Fan = OR7.Appliance(OR7,1,70, 2, 720,0.15)
OR7_Fan.windows([480,1440],[0,0],0.2)
OR7_Fan1 = OR7.Appliance(OR7,1,70, 2, 720,0.15,15,occasional_use=0.75)
OR7_Fan1.windows([0,1440],[0,0],0.2)
...
OR8_Fan = OR8.Appliance(OR8,1,30, 2, 720,0.15)
OR8_Fan.windows([480,1440],[0,0],0.2)
OR8_Fan1 = OR8.Appliance(OR8,1,30, 2, 720,0.15,15,occasional_use=0.75)
OR8_Fan1.windows([0,1440],[0,0],0.2)
