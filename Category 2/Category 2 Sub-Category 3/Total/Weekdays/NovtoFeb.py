...
OR_lavatory_LEDBulb.windows([541,1440],[360,540],0.1)
OR_lavatory_LEDBulb1 = OR.Appliance(OR,1,5,2,60,0.2,5)
OR_lavatory_LEDBulb1.windows([541,1440],[360,540],0.1)
...
OR_RoomHeater = OR.Appliance(OR,1,2000,2,240,0.1,30, 'yes',1, occasional_use = 0.25)
...
#One-Room Minimum Connected Load
OR1_indoor_LEDBulb1 = OR1.Appliance(OR1,1,7,2,420,0.15,15, occasional_use = 0.5)
OR1_indoor_LEDBulb1.windows([1080,1440],[300,420],0.1)
OR1_indoor_LEDBulb2 = OR1.Appliance(OR1,1,7,2,120,0.15,15)
OR1_indoor_LEDBulb2.windows([1080,1440],[300,420],0.3)
OR1_lavatory_LEDBulb = OR1.Appliance(OR1,1,5,2,60,0.2,5)
OR1_lavatory_LEDBulb.windows([360,1440],[0,0],0.1)
OR1_TV=OR.Appliance(OR1,1,60,2,360,0.2,30)
...
OR1_ImmersionHeater = OR1.Appliance(OR1,1,1000,2,60,0.3,15)
OR1_ImmersionHeater.windows([360,900],[0,0],0.35)
...
OR2_lavatory_LEDBulb = OR2.Appliance(OR2,1,5,2,60,0.2,5)
OR2_lavatory_LEDBulb.windows([541,1440],[360,540],0.1)
OR2_lavatory_LEDBulb1 = OR2.Appliance(OR2,1,5,2,60,0.2,5)
OR2_lavatory_LEDBulb1.windows([541,1440],[360,540],0.1)
OR2_Phone_charger = OR2.Appliance(OR2,2,5,2,180,0.3,15)
...
OR2_laptop = OR2.Appliance(OR2,1,50,1,240,0.15,30, occasional_use = 0.75)
...
OR2_RoomHeater = OR2.Appliance(OR2,1,2000,2,240,0.1,30, 'yes',1, occasional_use = 0.25)
OR2_RoomHeater.windows([1080,1440],[0,0],0.1)
OR2_RoomHeater.specific_cycle_1(20,20,2000,10)
...
OR3_Camera_charger = OR3.Appliance(OR3,2,5,2,180,0.3,15,occasional_use=0.25)
...
OR4_MosquitoRepellent1 = OR4.Appliance(OR4,1,7,2,480,0.15,30, occasional_use=0.5)
OR4_MosquitoRepellent1.windows([1080,1440],[0,0],0.35)
OR4_BathroomGeyser = OR4.Appliance(OR4,1,2000,2,60,0.1,15, 'yes',1,occasional_use=0.75)
...
#One-Room Minimum Connected Load
OR6_indoor_Tubelight1 = OR6.Appliance(OR6,1,55,2,420,0.15,15, occasional_use = 0.5)
OR6_indoor_Tubelight1.windows([1080,1440],[300,420],0.1)
OR6_indoor_Tubelight2 = OR6.Appliance(OR6,1,55,2,120,0.15,15)
OR6_indoor_Tubelight2.windows([1080,1440],[300,420],0.3)
OR6_lavatory_LEDBulb = OR6.Appliance(OR6,1,5,2,60,0.2,5)
OR6_lavatory_LEDBulb.windows([541,1440],[360,540],0.1)
...
OR6_KitchenTubelight.windows([1140,1380],[360,600],0.25,[720,900])
...
OR6_Iron = OR6.Appliance(OR6,1,1200,1,30,0.15,15, occasional_use=0.5)
OR6_Iron.windows([900,1320],[0,0],0.3)
...
OR6_BathroomGeyser = OR6.Appliance(OR6,1,2000,2,60,0.1,15, 'yes',1,occasional_use=0.75)
...
OR7_lavatory_LEDBulb = OR7.Appliance(OR7,1,5,2,60,0.2,5)
OR7_lavatory_LEDBulb.windows([541,1440],[360,540],0.1)
OR7_Phone_charger = OR7.Appliance(OR7,2,5,2,180,0.3,15)
OR7_Phone_charger.windows([0,1440],[0,0],0.35)
OR7_TV=OR7.Appliance(OR7,1,60,2,360,0.2,30)
OR7_TV.windows([540,1440],[0,0], 0.35)
OR7_SetTopBox = OR7.Appliance(OR7,1,10,2,360,0.2,30,occasional_use=0.5)
OR7_SetTopBox.windows([540,1400],[0,0],0.35)
OR7_KitchenTubelight=OR7.Appliance(OR7, 1,40,3,300,0.15,15)
OR7_KitchenTubelight.windows([1140,1380],[360,600],0.25,[720,900])
...
OR7_Iron = OR7.Appliance(OR7,1,1200,1,30,0.15,15, occasional_use=0.5)
OR7_Iron.windows([900,1320],[0,0],0.3)
OR7_ImmersionHeater = OR7.Appliance(OR7,1,1000,2,60,0.3,15)
OR7_ImmersionHeater.windows([360,540],[541,1200],0.35)

#Create new user classes
OR8 = User("Case9",5,1)
User_list.append(OR8)
#One-Room Minimum Connected Load
OR8_indoor_LEDBulb1 = OR8.Appliance(OR8,1,7,2,420,0.15,15, occasional_use = 0.5)
OR8_indoor_LEDBulb1.windows([1080,1440],[300,420],0.1)
OR8_indoor_LEDBulb2 = OR8.Appliance(OR8,1,7,2,120,0.15,15)
OR8_indoor_LEDBulb2.windows([1080,1440],[300,420],0.3)
OR8_lavatory_LEDBulb = OR8.Appliance(OR8,1,5,2,60,0.2,5)
OR8_lavatory_LEDBulb.windows([360,540],[541,1440],0.1)
OR8_TV=OR8.Appliance(OR8,1,60,2,360,0.2,30)
OR8_TV.windows([540,1440],[0,0], 0.35)
OR8_SetTopBox = OR8.Appliance(OR8,1,10,2,360,0.2,30,occasional_use=0.5)
OR8_SetTopBox.windows([540,1400],[0,0],0.35)
OR8_KitchenLED=OR8.Appliance(OR8,1,7,3,300,0.15,15)
OR8_KitchenLED.windows([1140,1380],[360,600],0.25,[720,900])
OR8_Fridge = OR8.Appliance(OR8,1,200,1,1440,0,45, 'yes',1)
OR8_Fridge.windows([0,1440],[0,0])
OR8_Fridge.specific_cycle_1(5,45,200,45)
OR8_Fridge.cycle_behaviour([0,1440],[0,0])
OR8_InductionCooktop = OR8.Appliance(OR8,1,2000,3,150,0.1,15, 'yes',1, occasional_use=0.5)
OR8_InductionCooktop.windows([720,900],[1080,1320],0.15, [360,480])
OR8_InductionCooktop.specific_cycle_1(500,15,2000,15)
OR8_InductionCooktop.cycle_behaviour([1080,1320],[720,900])
OR8_BathroomGeyser = OR8.Appliance(OR8,1,2000,2,60,0.1,15, 'yes',1,occasional_use=0.75)
OR8_BathroomGeyser.windows([420,540],[541,900],0.1,[1080,1200])
OR8_BathroomGeyser.specific_cycle_1(2000,10,10,5)
OR8_BathroomGeyser.cycle_behaviour([420,900],[0,0])
