...
OR_BathroomGeyser = OR.Appliance(OR,4,2000,3,60,0.1,15, 'yes',1,occasional_use=0.75)
...
OR3_BathroomGeyser = OR3.Appliance(OR3,3,2000,3,60,0.1,15, 'yes',1,occasional_use=0.9)
