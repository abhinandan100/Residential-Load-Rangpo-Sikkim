...
#One-Room Minimum Connected Load
OR_Fans0 = OR.Appliance(OR,4,70, 2, 960,0.15,15,occasional_use=0.75)
OR_Fans0.windows([480,1440],[0,0],0.2)
OR_Fans1 = OR.Appliance(OR,3,70, 2, 480,0.15,15,occasional_use=0.5)
...
OR_indoor_Tubelights3 = OR.Appliance(OR,7,55,2,420,0.15,15, occasional_use = 0.2)
OR_indoor_Tubelights3.windows([1080,1440],[300,420],0.1)
OR_lavatory_Tubelights = OR.Appliance(OR,4,55,2,60,0.2,5)
OR_lavatory_Tubelights.windows([0,1440],[0,0],0.1)
...
OR_hairdrier.windows([480,900],[0,0],0.1)
...
OR_SetTopBox.windows([540,1440],[0,0],0.35)
...
OR_BathroomGeyser = OR.Appliance(OR,4,2000,2,60,0.1,15, 'yes',1,occasional_use=0.5)
...
OR3_lavatory_ExhaustFan.windows([360,1440],[0,0],0.1)
...
OR3_BathroomGeyser = OR3.Appliance(OR3,3,2000,2,60,0.1,15, 'yes',1,occasional_use=0.25)
OR3_BathroomGeyser.windows([420,900],[0,0],0.1,[0,0])
