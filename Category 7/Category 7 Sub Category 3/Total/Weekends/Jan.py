...
OR_BathroomGeyser = OR.Appliance(OR,4,2000,2,60,0.1,15, 'yes',1,occasional_use=0.75)
...
OR_RoomHeater = OR.Appliance(OR,2,2000,2,120,0.1,30, 'yes',1, occasional_use=0.75)
...
OR_KitchenGeyser = OR.Appliance(OR,1,2000,2,30,0.1,15, 'yes',1, occasional_use=0.75)
...
OR1_indoor_Lamps3 = OR1.Appliance(OR1,2,30,2,420,0.15,15, occasional_use = 0.2)
OR1_indoor_Lamps3.windows([1080,1440],[0,0],0.1)
OR1_BathroomGeyser = OR1.Appliance(OR1,1,2000,2,60,0.1,15, 'yes',1,occasional_use=0.9)
...
OR1_BathroomGeyser1 = OR1.Appliance(OR1,1,2000,2,60,0.1,15, 'yes',1,occasional_use=0.1)
...
OR2_BathroomGeyser = OR2.Appliance(OR2,3,2000,3,60,0.1,15, 'yes',1,occasional_use=0.75)
OR2_BathroomGeyser.windows([420,540],[541,900],0.1,[1080,1200])
OR2_BathroomGeyser.specific_cycle_1(2000,10,10,5)
OR2_BathroomGeyser.cycle_behaviour([420,900],[0,0])
OR2_RoomHeater = OR2.Appliance(OR2,2,2000,2,120,0.1,30, 'yes',1, occasional_use=0.75)
...
OR3_lavatory_Tubelights.windows([0,1440],[0,0],0.1)
...
OR3_BathroomGeyser = OR3.Appliance(OR3,3,2000,2,60,0.1,15, 'yes',1,occasional_use=0.9)
...
OR3_RoomHeater = OR3.Appliance(OR3,2,2000,2,120,0.1,30, 'yes',1, occasional_use=0.75)
