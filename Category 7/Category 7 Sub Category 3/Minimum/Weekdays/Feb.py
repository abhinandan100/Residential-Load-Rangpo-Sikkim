...
OR_indoor_Lamps3 = OR.Appliance(OR,2,30,2,420,0.15,15, occasional_use = 0.2)
OR_indoor_Lamps3.windows([1080,1440],[0,0],0.1)
OR_BathroomGeyser = OR.Appliance(OR,1,2000,2,60,0.1,15, 'yes',1,occasional_use=0.9)
...
OR_BathroomGeyser1 = OR.Appliance(OR,1,2000,2,60,0.1,15, 'yes',1,occasional_use=0.1)
