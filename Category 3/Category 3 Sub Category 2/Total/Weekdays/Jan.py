...
OR_RoomHeater = OR.Appliance(OR,1,2400,2,240,0.1,30, 'yes',1, occasional_use = 0.25)
...
OR3_BathroomGeyser = OR3.Appliance(OR3,1,1500,2,60,0.1,15, 'yes',1, occasional_use=0.35)
OR3_BathroomGeyser.windows([480,960],[0,0],0.1)
OR3_BathroomGeyser.specific_cycle_1(1500,10,10,5)
OR3_BathroomGeyser.cycle_behaviour([480,960],[0,0])
