...
OR_indoor_LEDlight2 = OR.Appliance(OR,2,7,2,120,0.15,15, occasional_use = 0.5)
...
OR_KitchenLEDlight=OR.Appliance(OR,1,40,2,180,0.15,15)
OR_KitchenLEDlight.windows([1320,1440],[0,120],0.2)
...
OR_WaterPurifier.windows([480,720],[0,0],0.3)
