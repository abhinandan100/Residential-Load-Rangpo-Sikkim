...
OR_AirConditioner.cycle_behaviour([1080,1140],[360,540])
...
OR1_Fan = OR1.Appliance(OR1,1,70, 2, 720,0.15, occasional_use=0.5)
OR1_Fan.windows([480,1440],[0,0],0.2)
OR1_Fan1 = OR1.Appliance(OR1,1,70, 2, 720,0.15,15,occasional_use=0.25)
OR1_Fan1.windows([0,1440],[0,0],0.2)
OR1_Fan2 = OR1.Appliance(OR1,1,70, 2, 720,0.15,15,occasional_use=0.25)
OR1_Fan2.windows([480,1440],[0,0],0.2)
...
OR2_Fan2 = OR2.Appliance(OR2,1,70, 2, 720,0.15,15,occasional_use=0.25)
...
OR3_Fan2 = OR3.Appliance(OR3,1,70, 2, 720,0.15,15,occasional_use=0.25)
...
OR4_Fan2 = OR4.Appliance(OR4,1,70, 2, 720,0.15,15,occasional_use=0.25)
...
OR5_Fan = OR5.Appliance(OR5,1,70, 2, 720,0.15, occasional_use=0.5)
OR5_Fan.windows([480,1440],[0,0],0.2)
OR5_Fan1 = OR5.Appliance(OR5,1,70, 2, 720,0.15,15,occasional_use=0.25)
OR5_Fan1.windows([0,1440],[0,0],0.2)
OR5_Fan2 = OR5.Appliance(OR5,1,70, 2, 720,0.15,15,occasional_use=0.25)
