...
OR_KitchenGeyser = OR.Appliance(OR,1,2000,2,60,0.1,15, 'yes',1, occasional_use=0.5)
OR_KitchenGeyser.windows([1200,1380],[0,0],0.1)
OR_KitchenGeyser.specific_cycle_1(2000,10,10,5)
OR_KitchenGeyser.cycle_behaviour([1200,1380],[360,540])

#One-Room Minimum Connected Load
OR1_indoor_LEDBulb = OR1.Appliance(OR1,1,7,2,360,0.15,15,occasional_use=0.5)
...
OR1_indoor_LEDBulb3 = OR1.Appliance(OR1,1,7,2,360,0.15,15,occasional_use=0.5)
OR1_indoor_LEDBulb3.windows([1080,1440],[0,0],0.1)
OR1_lavatory_LEDBulb = OR1.Appliance(OR1,1,5,2,45,0.2,5,occasional_use=0.5)
OR1_lavatory_LEDBulb.windows([0,1440],[0,0],0.1)
OR1_Phone_charger = OR1.Appliance(OR1,2,5,2,180,0.3,15, occasional_use=0.5)
OR1_Phone_charger.windows([0,1440],[0,0],0.35)
OR1_KitchenLED=OR1.Appliance(OR1,1,7,2,180,0.15,15, occasional_use=0.5)
OR1_KitchenLED.windows([1080,1380],[360,420],0.2)
OR1_KitchenExhaustFan=OR1.Appliance(OR1,1,40,2,180,0.15,15,occasional_use = 0.5)
OR1_KitchenExhaustFan.windows([1140,1380],[420,600],0.2,[720,900])
OR1_TV=OR1.Appliance(OR1,1,60,2,360,0.2,30,occasional_use = 0.5)
...
OR1_BathroomGeyser = OR1.Appliance(OR1,1,2000,2,60,0.1,15, 'yes',1,occasional_use=0.5)
...
OR2_indoor_Tubelight2 = OR2.Appliance(OR2,1,55,2,120,0.15,15, occasional_use = 0.25)
...
OR2_indoor_Tubelight4 = OR2.Appliance(OR2,1,55,2,420,0.15,15, occasional_use = 0.25)
OR2_indoor_Tubelight4.windows([1080,1440],[300,420],0.1)
OR2_indoor_Tubelight5 = OR2.Appliance(OR2,1,55,2,120,0.15,15, occasional_use = 0.5)
OR2_indoor_Tubelight5.windows([1080,1440],[300,420],0.3)
OR2_indoor_Tubelight6 = OR2.Appliance(OR2,1,55,2,420,0.15,15, occasional_use = 0.25)
OR2_indoor_Tubelight6.windows([1080,1440],[300,420],0.1)
OR2_lavatory_Tubelight = OR2.Appliance(OR2,1,55,2,45,0.2,5,occasional_use = 0.5)
OR2_lavatory_Tubelight.windows([0,1440],[0,0],0.1)
OR2_lavatory_Tubelight1 = OR2.Appliance(OR2,1,55,2,30,0.2,5,occasional_use = 0.5)
OR2_lavatory_Tubelight1.windows([0,1440],[0,0],0.1)
OR2_Phone_charger = OR2.Appliance(OR2,2,5,1,180,0.3,15, occasional_use = 0.5)
OR2_Phone_charger.windows([0,1440],[0,0],0.35)
OR2_TV=OR2.Appliance(OR2,2,60,2,360,0.2,30,occasional_use = 0.5)
...
OR2_ElectricKettle = OR2.Appliance(OR2,1,1200,2,20,0.15,15, occasional_use=0.5)
...
OR3_indoor_Tubelight2 = OR3.Appliance(OR3,1,55,2,120,0.15,15, occasional_use = 0.25)
...
OR3_indoor_Tubelight4 = OR3.Appliance(OR3,1,55,2,420,0.15,15, occasional_use = 0.25)
OR3_indoor_Tubelight4.windows([1080,1440],[300,420],0.1)
OR3_indoor_Tubelight5 = OR3.Appliance(OR3,1,55,2,120,0.15,15, occasional_use = 0.5)
OR3_indoor_Tubelight5.windows([1080,1440],[300,420],0.3)
OR3_indoor_Tubelight6 = OR3.Appliance(OR3,1,55,2,420,0.15,15, occasional_use = 0.25)
OR3_indoor_Tubelight6.windows([1080,1440],[300,420],0.1)
OR3_lavatory_Tubelight = OR3.Appliance(OR3,1,55,2,45,0.2,5,occasional_use = 0.5)
OR3_lavatory_Tubelight.windows([0,1440],[0,0],0.1)
OR3_lavatory_Tubelight1 = OR3.Appliance(OR3,1,55,2,30,0.2,5,occasional_use = 0.5)
OR3_lavatory_Tubelight1.windows([0,1440],[0,0],0.1)
OR3_Phone_charger = OR3.Appliance(OR3,2,5,1,180,0.3,15, occasional_use = 0.5)
...
OR3_Fridge = OR2.Appliance(OR2,1,200,1,1440,0,45, 'yes',1)
OR3_Fridge.windows([0,1440],[0,0])
OR3_Fridge.specific_cycle_1(5,45,200,45)
OR3_Fridge.cycle_behaviour([0,720],[721,1440])
OR3_WashingMachine=OR2.Appliance(OR2,1,600,2,120,0.2,30, occasional_use=0.5)
OR3_WashingMachine.windows([480,720],[0,0],0.25)
OR3_MicroWaveOven=OR2.Appliance(OR2,1,1200,3,60,0.2,15, occasional_use=0.5)
OR3_MicroWaveOven.windows([1080,1320],[420,600], 0.15, [720,900])
OR3_MixerGrinder = OR2.Appliance(OR2,1,500,2,60,0.15,15,occasional_use = 0.33)
OR3_MixerGrinder.windows([1080,1320],[420,600],0.3, [720,900])
OR3_WaterPurifier = OR2.Appliance(OR2,1,60,2,60,0.15,15)
OR3_WaterPurifier.windows([1080,1380],[420,900],0.3)
OR3_Iron = OR2.Appliance(OR2,1,1200,1,30,0.15,15, occasional_use=0.5)
OR3_Iron.windows([900,1320],[0,0],0.3)
OR3_SetTopBox = OR2.Appliance(OR2,1,10,2,360,0.2,30,occasional_use=0.5)
OR3_SetTopBox.windows([540,1400],[0,0],0.35)
OR3_MosquitoRepellent = OR2.Appliance(OR2,1,7,2,480,0.15,30,occasional_use=0.5)
OR3_MosquitoRepellent.windows([1200,1440],[0,360],0.35)
OR3_MosquitoRepellent1 = OR2.Appliance(OR2,1,7,2,480,0.15,30, occasional_use=0.5)
...
OR4_indoor_Tubelight2 = OR4.Appliance(OR4,1,55,2,120,0.15,15, occasional_use = 0.25)
...
OR4_indoor_Tubelight4 = OR4.Appliance(OR4,1,55,2,420,0.15,15, occasional_use = 0.25)
OR4_indoor_Tubelight4.windows([1080,1440],[300,420],0.1)
OR4_indoor_Tubelight5 = OR4.Appliance(OR4,1,55,2,120,0.15,15, occasional_use = 0.5)
OR4_indoor_Tubelight5.windows([1080,1440],[300,420],0.3)
OR4_indoor_Tubelight6 = OR4.Appliance(OR4,1,55,2,420,0.15,15, occasional_use = 0.25)
OR4_indoor_Tubelight6.windows([1080,1440],[300,420],0.1)
OR4_Lavatory_LEDBulb = OR4.Appliance(OR4,1,7,2,45,0.2,5,occasional_use = 0.5)
OR4_Lavatory_LEDBulb.windows([0,1440],[0,0],0.1)
OR4_Lavatory_LEDBulb1 = OR4.Appliance(OR4,1,7,2,45,0.2,5,occasional_use = 0.5)
OR4_Lavatory_LEDBulb1.windows([0,1440],[0,0],0.1)
OR4_Phone_charger = OR4.Appliance(OR4,2,5,1,180,0.3,15, occasional_use = 0.5)
...
OR4_WashingMachine=OR4.Appliance(OR4,1,600,2,120,0.2,30, occasional_use=0.5)
OR4_WashingMachine.windows([480,720],[0,0],0.25)
...
OR4_Desktopcomputer = OR4.Appliance(OR4,1,120,2,360,0.15,30,occasional_use = 0.33)
OR4_Desktopcomputer.windows([540,1440],[0,0],0.1)
OR4_BathroomGeyser = OR4.Appliance(OR4,1,2000,2,60,0.1,15, 'yes',1,occasional_use=0.5)
OR4_BathroomGeyser.windows([420,900],[0,0],0.1)
...
OR5_indoor_Tubelight2 = OR5.Appliance(OR5,1,55,2,120,0.15,15, occasional_use = 0.25)
OR5_indoor_Tubelight2.windows([1080,1440],[300,420],0.3)
OR5_indoor_Tubelight3 = OR5.Appliance(OR5,1,55,2,420,0.15,15, occasional_use = 0.5)
OR5_indoor_Tubelight3.windows([1080,1440],[300,420],0.1)
OR5_indoor_Tubelight4 = OR5.Appliance(OR5,1,55,2,420,0.15,15, occasional_use = 0.25)
OR5_indoor_Tubelight4.windows([1080,1440],[300,420],0.1)
OR5_indoor_LEDBulb = OR5.Appliance(OR5,1,7,2,120,0.15,15, occasional_use = 0.5)
OR5_indoor_LEDBulb.windows([1080,1440],[300,420],0.3)
OR5_Lavatory_LEDBulb = OR5.Appliance(OR5,1,5,2,45,0.2,5,occasional_use = 0.5)
OR5_Lavatory_LEDBulb.windows([0,1440],[0,0],0.1)
OR5_Phone_charger = OR5.Appliance(OR5,2,5,1,180,0.3,15, occasional_use = 0.5)
OR5_Phone_charger.windows([0,1440],[0,0],0.35)
OR5_TV=OR5.Appliance(OR5,1,60,2,360,0.2,30,occasional_use = 0.5)
OR5_TV.windows([540,1440],[0,0], 0.35)
OR5_KitchenTubelight=OR5.Appliance(OR5,1,40,3,300,0.15,15,occasional_use = 0.5)
OR5_KitchenTubelight.windows([1140,1380],[420,600],0.25,[720,900])
OR5_KitchenExhaustFan=OR5.Appliance(OR5,1,40,2,180,0.15,15,occasional_use = 0.5)
...
OR5_WashingMachine=OR5.Appliance(OR5,1,600,2,120,0.2,30, occasional_use=0.5)
OR5_WashingMachine.windows([480,720],[0,0],0.25)
