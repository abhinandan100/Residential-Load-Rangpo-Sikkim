...
OR_Fan2 = OR.Appliance(OR,1,70, 2, 720,0.15,15,occasional_use=0.75)
...
OR1_indoor_LEDBulb3 = OR1.Appliance(OR1,1,7,2,120,0.15,15)
...
OR1_Fan = OR.Appliance(OR,1,30, 2, 720,0.15)
OR1_Fan.windows([480,1440],[0,0],0.2)
OR1_Fan1 = OR.Appliance(OR,1,30, 2, 720,0.15,15,occasional_use=0.75)
OR1_Fan1.windows([0,1440],[0,0],0.2)
OR1_Fan2 = OR.Appliance(OR,1,30, 2, 720,0.15,15,occasional_use=0.75)
