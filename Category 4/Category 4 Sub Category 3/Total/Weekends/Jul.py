...
#One-Room Minimum Connected Load
OR_Fans0 = OR.Appliance(OR,2,70, 2, 960,0.15,occasional_use=0.75)
OR_Fans0.windows([480,1440],[0,0],0.2)
OR_Fans1 = OR.Appliance(OR,2,70, 2, 600,0.15,15,occasional_use=0.5)
OR_Fans1.windows([1260,1440],[0,480],0.2)
OR_SmallFans1 = OR.Appliance(OR,2,40, 2, 360,0.15,15,occasional_use=0.5)
...
OR_BathroomGeyser = OR.Appliance(OR,3,2000,3,60,0.1,15, 'yes',1,occasional_use=0.25)
...
#One-Room Minimum Connected Load
OR1_Fans0 = OR1.Appliance(OR1,2,70, 2, 960,0.15,15,occasional_use=0.8)
...
OR2_lavatory_Tubelights = OR2.Appliance(OR2,2,55,2,60,0.2,5)
OR2_lavatory_Tubelights.windows([541,1440],[360,540],0.1)
OR2_lavatory_ExhaustFan = OR2.Appliance(OR2,2,40,2,30,0.2,5)
...
OR2_SetTopBox = OR2.Appliance(OR2,1,10,2,720,0.2,30)
OR2_SetTopBox.windows([420,1440],[0,0],0.35)
