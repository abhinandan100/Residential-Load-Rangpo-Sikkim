...
#One-Room Minimum Connected Load
OR_SmallFans1 = OR.Appliance(OR,2,40, 2, 360,0.15,15,occasional_use=0.2)
...
OR_indoor_Nightlights3 = OR.Appliance(OR,6,6,2,420,0.15,15, occasional_use = 0.3)
...
OR_DesktopPC = OR.Appliance(OR,1,120,1,240,0.15,30, occasional_use = 0.75)
...
OR_WashingMachine=OR.Appliance(OR,1,600,2,120,0.2,30)
...
OR_BathroomGeyser = OR.Appliance(OR,3,2000,3,60,0.1,15, 'yes',1,occasional_use=0.5)
OR_BathroomGeyser.windows([420,540],[541,900],0.1,[1080,1200])
OR_BathroomGeyser.specific_cycle_1(2000,10,10,5)
OR_BathroomGeyser.cycle_behaviour([420,960],[960,1140])
...
OR_RoomHeater = OR.Appliance(OR,3,1200,2,360,0.3,30, occasional_use=0.75)
OR_RoomHeater.windows([960,1440],[300,420],0.3)
...
#One-Room Minimum Connected Load
OR1_indoor_LED1 = OR1.Appliance(OR1,2,9,2,360,0.15,15)
OR1_indoor_LED1.windows([1080,1440],[0,60],0.15)
...
OR1_lavatory_LED = OR1.Appliance(OR1,2,9,2,60,0.2,5)
OR1_lavatory_LED.windows([360,1440],[0,120],0.1)
...
OR1_TV.windows([420,1410],[0,0], 0.35)
OR1_SetTopBox = OR1.Appliance(OR1,1,10,2,420,0.2,30)
OR1_SetTopBox.windows([420,1410],[0,0],0.35)
...
OR1_BathroomGeyser.windows([420,960],[0,0],0.1)
OR1_BathroomGeyser.specific_cycle_1(1500,10,10,5)
OR1_BathroomGeyser.cycle_behaviour([420,960],[0,0])

#One-Room Minimum Connected Load
#Create new user classes
OR2 = User("One room minimal",5,1)
User_list.append(OR2)

#One-Room Minimum Connected Load
OR2_Fans0 = OR2.Appliance(OR2,2,70, 2, 960,0.15,occasional_use=0.75)
OR2_Fans0.windows([480,1440],[0,0],0.2)
OR2_Fans1 = OR2.Appliance(OR2,2,70, 2, 600,0.15,15,occasional_use=0.5)
OR2_Fans1.windows([1260,1440],[0,480],0.2)
OR2_SmallFans1 = OR2.Appliance(OR2,2,40, 2, 360,0.15,15,occasional_use=0.5)
OR2_SmallFans1.windows([480,1440],[0,0],0.2)
OR2_indoor_Tubelights1 = OR2.Appliance(OR2,4,55,3,480,0.15,15)
...
OR2_indoor_Nightlights3 = OR2.Appliance(OR2,6,6,2,420,0.15,15, occasional_use = 0.3)
...
OR2_TV=OR2.Appliance(OR2,1,60,2,720,0.2,30)
...
OR2_WashingMachine=OR2.Appliance(OR2,1,600,2,60,0.2,30)
...
OR2_MosquitoRepellent = OR2.Appliance(OR2,3,7,2,480,0.15,30, occasional_use=0.5)
OR2_MosquitoRepellent.windows([1080,1440],[0,360],0.35)
...
OR2_CakeBlender=OR2.Appliance(OR2,1,300,2,60,0.5,45, occasional_use=0.5)
OR2_CakeBlender.windows([900,1200],[0,0], 0.5)
OR2_BathroomGeyser = OR2.Appliance(OR2,1,1500,2,60,0.1,15, 'yes',1,occasional_use=0.75)
OR2_BathroomGeyser.windows([420,960],[0,0],0.1)
OR2_BathroomGeyser.specific_cycle_1(1500,10,10,5)
OR2_BathroomGeyser.cycle_behaviour([420,960],[0,0])

#One-Room Minimum Connected Load
#Create new user classes
OR3 = User("One room minimal",2,1)
User_list.append(OR3)

#One-Room Minimum Connected Load
OR3_Fans0 = OR3.Appliance(OR3,3,70, 2, 960,0.15)
OR3_Fans0.windows([480,1440],[0,0],0.2)
OR3_Fans1 = OR3.Appliance(OR3,2,70, 2, 600,0.15,15,occasional_use=0.5)
OR3_Fans1.windows([1260,1440],[0,480],0.2)
OR3_indoor_Tubelights1 = OR3.Appliance(OR3,4,55,3,480,0.15,15)
OR3_indoor_Tubelights1.windows([1080,1440],[300,420],0.1, [720,900])
OR3_indoor_Nightlights3 = OR3.Appliance(OR3,6,9,2,420,0.15,15, occasional_use = 0.3)
OR3_indoor_Nightlights3.windows([1080,1440],[300,420],0.1)
OR3_lavatory_Tubelights = OR3.Appliance(OR3,2,55,2,60,0.2,5)
...
OR3_TV=OR3.Appliance(OR3,1,60,2,720,0.2,30)
OR3_TV.windows([420,1440],[0,0], 0.35)
OR3_SetTopBox = OR3.Appliance(OR3,1,10,2,720,0.2,30)
OR3_SetTopBox.windows([420,1440],[0,0],0.35)
...
OR3_WashingMachine=OR3.Appliance(OR3,1,600,2,60,0.2,30)
...
OR3_MosquitoRepellent = OR3.Appliance(OR3,3,7,2,480,0.15,30, occasional_use=0.5)
OR3_MosquitoRepellent.windows([1080,1440],[0,360],0.35)
...
OR3_BathroomGeyser = OR3.Appliance(OR3,1,1500,3,90,0.1,15, 'yes',1,occasional_use=0.5)
OR3_BathroomGeyser.windows([420,540],[541,900],0.1,[1080,1200])
OR3_BathroomGeyser.specific_cycle_1(2000,10,10,5)
OR3_BathroomGeyser.cycle_behaviour([420,960],[960,1140])
OR3_KitchenGeyser = OR3.Appliance(OR3,1,1500,2,30,0.1,15, 'yes',1, occasional_use=0.75)
OR3_KitchenGeyser.windows([1200,1380],[360,540],0.1)
OR3_KitchenGeyser.specific_cycle_1(2000,10,10,5)
OR3_KitchenGeyser.cycle_behaviour([1200,1380],[360,540])

#One-Room Minimum Connected Load
#Create new user classes
OR4 = User("One room minimal",3,1)
User_list.append(OR4)

#One-Room Minimum Connected Load
OR4_Fans0 = OR4.Appliance(OR4,3,70, 2, 960,0.15)
OR4_Fans0.windows([480,1440],[0,0],0.2)
OR4_Fans1 = OR4.Appliance(OR4,2,70, 2, 600,0.15,15,occasional_use=0.5)
OR4_Fans1.windows([1260,1440],[0,480],0.2)
OR4_indoor_Tubelights1 = OR4.Appliance(OR4,4,55,3,480,0.15,15)
OR4_indoor_Tubelights1.windows([1080,1440],[300,420],0.1, [720,900])
OR4_indoor_Nightlights3 = OR4.Appliance(OR4,6,9,2,420,0.15,15, occasional_use = 0.3)
OR4_indoor_Nightlights3.windows([1080,1440],[300,420],0.1)
OR4_lavatory_Tubelights = OR4.Appliance(OR4,2,55,2,60,0.2,5)
...
OR4_TV=OR4.Appliance(OR4,1,60,2,720,0.2,30)
OR4_TV.windows([420,1440],[0,0], 0.35)
OR4_SetTopBox = OR4.Appliance(OR4,1,10,2,720,0.2,30)
OR4_SetTopBox.windows([420,1440],[0,0],0.35)
...
OR4_WashingMachine=OR4.Appliance(OR4,1,600,2,60,0.2,30)
...
OR4_MosquitoRepellent = OR4.Appliance(OR4,3,7,2,480,0.15,30, occasional_use=0.5)
OR4_MosquitoRepellent.windows([1080,1440],[0,360],0.35)
OR4_ElectricKettle = OR4.Appliance(OR4,1,1200,2,30,0.15,15)
OR4_ElectricKettle.windows([1080,1320],[360,600],0.3)
OR4_BathroomGeyser = OR4.Appliance(OR4,1,1500,3,90,0.1,15, 'yes',1,occasional_use=0.5)
OR4_BathroomGeyser.windows([420,540],[541,900],0.1,[1080,1200])
OR4_BathroomGeyser.specific_cycle_1(2000,10,10,5)
OR4_BathroomGeyser.cycle_behaviour([420,960],[960,1140])
