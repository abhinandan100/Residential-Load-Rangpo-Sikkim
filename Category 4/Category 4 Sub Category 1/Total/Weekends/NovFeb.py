...
OR1_BathroomGeyser = OR1.Appliance(OR1,1,1500,2,60,0.1,15, 'yes',1, occasional_use=0.5)
...
OR_BathroomGeyser.windows([480,960],[0,0],0.1)
OR_BathroomGeyser.specific_cycle_1(2000,10,10,5)
OR_BathroomGeyser.cycle_behaviour([480,960],[0,0])
