...
OR_ElectricGuitar=OR.Appliance(OR,1,40,1,120,0.15,15, occasional_use=0.5)
OR_ElectricGuitar.windows([480,1380],[0,0],0.3)
...
OR1_lavatory_LEDBulb = OR1.Appliance(OR1,1,5,2,75,0.2,5)
...
OR1_MosquitoRepellent = OR1.Appliance(OR1,1,7,2,480,0.15,30, occasional_use=0.25)
...
#One-Room Minimum Connected Load
OR2_indoor_Tubelight1 = OR2.Appliance(OR2,1,55,2,330,0.15,15)
OR2_indoor_Tubelight1.windows([1080,1440],[0,0],0.1)
OR2_indoor_Tubelight2 = OR2.Appliance(OR2,1,55,2,120,0.15,15, occasional_use = 0.5)
OR2_indoor_Tubelight2.windows([1080,1440],[0,0],0.3)
OR2_indoor_Tubelight3 = OR2.Appliance(OR2,1,55,2,420,0.15,1)
OR2_indoor_Tubelight3.windows([1080,1440],[0,0],0.1)
...
OR2_indoor_LED.windows([1080,1440],[0,0],0.3)
...
OR2_TV.windows([480,1199],[1201,1440], 0.15)
OR2_SetTopBox = OR2.Appliance(OR2,1,10,2,180,0.15,30)
OR2_SetTopBox.windows([480,1199],[1201,1440],0.15)
OR2_KitchenTubelight=OR2.Appliance(OR2,1,40,2,180,0.15,15)
OR2_KitchenTubelight.windows([1140,1380],[0,0],0.2)
...
OR2_Fan = OR2.Appliance(OR2,2,70, 2, 1200,0.15)
OR2_Fan.windows([0,1440],[0,0],0.2)
OR2_Fan1 = OR2.Appliance(OR2,2,70, 2, 420,0.15,15,occasional_use=0.5)
OR2_Fan1.windows([480,1440],[0,0],0.2)
OR2_Fan2 = OR2.Appliance(OR2,1,70, 2, 360,0.15,15,occasional_use=0.25)
OR2_Fan2.windows([360,1440],[0,0],0.2)
OR2_WashingMachine=OR2.Appliance(OR2,1,600,2,30,0.2,30, occasional_use=0.5)
OR2_WashingMachine.windows([480,960],[0,0], 0.15)
OR2_MicroWaveOven=OR2.Appliance(OR2,1,1200,2,60,0.2,15, occasional_use=0.25)
OR2_MicroWaveOven.windows([480,600],[960,1120], 0.15)
...
OR2_MixerGrinder.windows([480,720],[1180,1320],0.3)
OR2_WaterPurifier = OR2.Appliance(OR2,1,60,2,60,0.15,15)
OR2_WaterPurifier.windows([1080,1380],[480,600],0.3)
OR2_Iron = OR2.Appliance(OR2,1,1200,2,30,0.15,15, occasional_use=0.5)
OR2_Iron.windows([960,1320],[0,0],0.3)
