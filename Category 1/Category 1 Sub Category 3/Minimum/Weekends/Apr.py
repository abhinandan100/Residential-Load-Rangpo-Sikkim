...
OR_indoor_LED = OR.Appliance(OR,1,55,2,420,0.15,15, occasional_use=0.75)
...
OR_Phone_charger = OR.Appliance(OR,3,5,2,200,0.3,15,occasional_use=0.75 )
...
OR_MosquitoRepellent = OR.Appliance(OR,1,7,2,480,0.15,30,occasional_use=0.75)
