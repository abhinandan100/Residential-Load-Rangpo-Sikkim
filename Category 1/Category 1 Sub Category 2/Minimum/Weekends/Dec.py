...
OR_indoor_LEDBulb = OR.Appliance(OR,1,7,2,480,0.35,15,occasional_use = 0.75)
OR_indoor_LEDBulb.windows([1020,1440],[300,420],0.3)
OR_lavatory_LEDBulb = OR.Appliance(OR,1,5,2,90,0.35,5,occasional_use = 0.75)
OR_lavatory_LEDBulb.windows([360,1440],[0,120], 0.35)
OR_Phone_charger = OR.Appliance(OR,1,5,2,180,0.35,15,occasional_use = 0.75)
