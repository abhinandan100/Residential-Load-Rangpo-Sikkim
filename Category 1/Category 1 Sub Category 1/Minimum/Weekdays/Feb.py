...
OR_indoor_LEDBulb.windows([1020,1440],[300,420],0.1)
OR_lavatory_LEDBulb = OR.Appliance(OR,1,5,2,45,0.15,5)
OR_lavatory_LEDBulb.windows([1080,1440],[300,420],0.3)
OR_Phone_charger = OR.Appliance(OR,1,5,2,120,0.15,15)
OR_Phone_charger.windows([1080,1440],[300,480],0.2 )
