...
#CASE9
OR8_TV=OR8.Appliance(OR8,1,60,2,180,0.2,30,occasional_use = 0.25)
...
OR8_InductionCooktop = OR8.Appliance(OR8,1,2000,3,150,0.1,15, 'yes',1)
OR8_InductionCooktop.windows([1110,1170],[1230,1350],0.15, [360,480])
OR8_InductionCooktop.specific_cycle_1(500,15,2000,15)
OR8_InductionCooktop.cycle_behaviour([1110,1350],[360,480])
