...
OR_SmallFans1 = OR.Appliance(OR,3,40, 2, 360,0.15,15,occasional_use=0.5)
...
OR3_SmallFans1 = OR3.Appliance(OR3,2,40, 2, 360,0.15,15,occasional_use=0.5)
OR3_SmallFans1.windows([480,1440],[0,0],0.2)
...
OR3_BathroomGeyser = OR.Appliance(OR,1,2000,3,60,0.1,15, 'yes',1,occasional_use=0.25)
...
#One-Room Minimum Connected Load
OR5_Fans0 = OR5.Appliance(OR5,3,70, 2, 960,0.15,occasional_use=0.75)
OR5_Fans0.windows([480,1440],[0,0],0.2)
OR5_Fans1 = OR5.Appliance(OR5,3,70, 2, 360,0.15,15,occasional_use=0.5)
OR5_Fans1.windows([1080,1440],[0,480],0.2)
...
OR5_indoor_Nightlights3.windows([1080,1440],[300,420],0.1)
OR5_lavatory_Tubelights = OR5.Appliance(OR5,4,55,2,60,0.2,5)
OR5_lavatory_Tubelights.windows([541,1440],[360,540],0.1)
OR5_lavatory_ExhaustFan = OR5.Appliance(OR5,4,40,2,30,0.2,5)
OR5_lavatory_ExhaustFan.windows([541,1440],[360,540],0.1)
...
#One-Room Minimum Connected Load
OR4_Fans0 = OR4.Appliance(OR4,3,70, 2, 960,0.15,occasional_use=0.75)
OR4_Fans0.windows([480,1440],[0,0],0.2)
OR4_Fans1 = OR4.Appliance(OR4,3,70, 2, 360,0.15,15,occasional_use=0.5)
...
OR4_lavatory_Tubelights = OR4.Appliance(OR4,4,55,2,60,0.2,5)
OR4_lavatory_Tubelights.windows([541,1440],[360,540],0.1)
OR4_lavatory_ExhaustFan = OR4.Appliance(OR4,4,40,2,30,0.2,5)
