...
#One-Room Minimum Connected Load
OR_Fans0 = OR.Appliance(OR,2,70, 2, 960,0.15)
...
OR_Fans2 = OR.Appliance(OR,1,70, 2, 360,0.15,15,occasional_use=0.2)
OR_Fans2.windows([1080,1440],[0,480],0.2)
OR_indoor_Tubelights1 = OR.Appliance(OR,2,55,2,360,0.15,15)
OR_indoor_Tubelights1.windows([1080,1440],[0,60],0.1)
...
OR_indoor_Lamps3 = OR.Appliance(OR,1,30,2,420,0.15,15, occasional_use = 0.2)
OR_indoor_Lamps3.windows([1080,1440],[0,0],0.1)
OR_lavatory_Tubelights = OR.Appliance(OR,2,55,2,60,0.2,5)
OR_lavatory_Tubelights.windows([360,1440],[0,120],0.1)
OR_lavatory_ExhaustFan1 = OR.Appliance(OR,2,40,2,40,0.2,5)
OR_lavatory_ExhaustFan1.windows([360,1440],[0,0],0.1)
