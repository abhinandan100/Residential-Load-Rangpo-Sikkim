...
#One-Room Minimum Connected Load
OR1_indoor_LED1 = OR1.Appliance(OR1,3,9,2,360,0.15,15)
OR1_indoor_LED1.windows([1080,1440],[0,60],0.1)
...
OR1_Iron = OR.Appliance(OR1,1,1200,1,30,0.15,15, occasional_use=0.5)
...
OR2_BathroomGeyser = OR2.Appliance(OR2,2,1500,2,90,0.1,15, 'yes',1,occasional_use=0.75)
...
OR3_BathroomGeyser = OR3.Appliance(OR3,4,2000,3,60,0.1,15, 'yes',1,occasional_use=0.9)
...
OR3_RoomHeater = OR3.Appliance(OR3,3,1200,2,120,0.3,30, occasional_use=0.25)
OR3_RoomHeater.windows([960,1380],[300,420],0.3)
