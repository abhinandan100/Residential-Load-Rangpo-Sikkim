...
OR_lavatory_Tubelights = OR.Appliance(OR,3,55,2,60,0.2,5)
OR_lavatory_Tubelights.windows([360,1440],[0,120],0.25)
OR_lavatory_ExhaustFan = OR.Appliance(OR,3,40,2,30,0.2,5)
OR_lavatory_ExhaustFan.windows([360,1440],[0,120],0.15)
...
OR_TV=OR.Appliance(OR,2,60,2,960,0.2,30)
