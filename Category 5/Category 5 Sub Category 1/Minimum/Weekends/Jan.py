...
OR_SetTopBox.windows([480,1380],[0,0],0.15)
...
OR_BathroomGeyser = OR.Appliance(OR,1,1500,2,60,0.1,15, 'yes',1, occasional_use=0.75)
OR_BathroomGeyser.windows([480,840],[0,0],0.1)
OR_BathroomGeyser.specific_cycle_1(2000,10,10,5)
OR_BathroomGeyser.cycle_behaviour([480,840],[0,0])
