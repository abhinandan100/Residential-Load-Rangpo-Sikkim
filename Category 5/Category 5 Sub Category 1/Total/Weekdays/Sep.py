...
OR1_lavatory_LEDBulb = OR1.Appliance(OR1,2,5,2,45,0.2,5)
...
OR1_WaterPurifier.windows([1080,1380],[360,540],0.3)
OR1_Iron = OR1.Appliance(OR1,1,1200,1,30,0.15,15, occasional_use=0.5)
OR1_Iron.windows([1080,1320],[0,0],0.3)
...
OR2_indoor_Tubelight1.windows([1140,1440],[300,420],0.3)
OR2_indoor_Tubelight2 = OR2.Appliance(OR2,1,55,2,120,0.15,15, occasional_use = 0.5)
OR2_indoor_Tubelight2.windows([1200,1440],[300,420],0.3)
OR2_indoor_Tubelight3 = OR2.Appliance(OR2,1,55,2,420,0.15,1)
OR2_indoor_Tubelight3.windows([1200,1440],[300,420],0.3)
...
OR2_indoor_LED.windows([1140,1440],[300,420],0.3)
OR2_lavatory_Tubelight = OR2.Appliance(OR2,1,55,2,45,0.2,5)
OR2_lavatory_Tubelight.windows([1140,1440],[300,420],0.1)
OR2_lavatory_Tubelight1 = OR2.Appliance(OR2,1,55,2,30,0.2,5)
OR2_lavatory_Tubelight1.windows([1140,1440],[300,480],0.1)
OR2_Phone_charger = OR2.Appliance(OR2,4,5,2,120,0.3,15)
OR2_Phone_charger.windows([1200,1440],[300,420],0.35)
OR2_TV=OR2.Appliance(OR2,2,60,2,300,0.2,30, occasional_use = 0.5)
OR2_TV.windows([1200,1440],[0,0], 0.2)
OR2_SetTopBox = OR2.Appliance(OR2,2,10,2,300,0.2,30,occasional_use = 0.5)
OR2_SetTopBox.windows([1200,1440],[0,0],0.2)
OR2_KitchenTubelight=OR2.Appliance(OR2,1,40,2,240,0.15,15)
OR2_KitchenTubelight.windows([1140,1380],[300,420],0.2)
OR2_KitchenExhaustFan=OR2.Appliance(OR2,1,40,2,180,0.15,15)
OR2_KitchenExhaustFan.windows([1140,1380],[300,420],0.2)
OR2_balcony_LED = OR2.Appliance(OR2,1,9,2,30,0.15,5)
OR2_balcony_LED.windows([1140,1159],[1201,1440],0.1)
OR2_laptop = OR2.Appliance(OR2,1,50,2,60,0.15,30,occasional_use = 0.5)
OR2_laptop.windows([1200,1440],[300,420],0.1)
OR2_hairtrimmercharger = OR2.Appliance(OR2,1,5,2,30,0.15,15,occasional_use = 0.2)
OR2_hairtrimmercharger.windows([300,420],[0,0],0.1)
OR2_WashingMachine=OR2.Appliance(OR2,1,600,2,120,0.2,30, occasional_use=0.5)
OR2_WashingMachine.windows([1180,1440],[300,420], 0.15)
OR2_VacuumCleaner=OR2.Appliance(OR2,1,1000,2,30,0.2,30, occasional_use=0.25)
OR2_VacuumCleaner.windows([300,450],[0,0], 0.15)
OR2_OvenToasterGriller=OR2.Appliance(OR2,1,1200,2,60,0.2,15, occasional_use=0.35)
OR2_OvenToasterGriller.windows([300,420],[0,0], 0.15)
...
OR2_MixerGrinder.windows([300,420],[1140,1320],0.3)
OR2_WaterPurifier = OR2.Appliance(OR2,1,60,2,90,0.15,15)
OR2_WaterPurifier.windows([1140,1380],[300,420],0.3)
...
OR3_Phone_charger.windows([1080,1440],[360,480],0.35)
OR3_TV=OR3.Appliance(OR3,1,60,2,300,0.2,30)
OR3_TV.windows([1080,1440],[360,420], 0.2)
OR3_SetTopBox = OR3.Appliance(OR3,1,10,2,300,0.2,30)
OR3_SetTopBox.windows([1080,1440],[360,420],0.2)
OR3_KitchenTubelight=OR3.Appliance(OR3,1,40,3,300,0.15,15)
OR3_KitchenTubelight.windows([1140,1380],[300,420],0.2)
OR3_KitchenExhaustFan=OR3.Appliance(OR3,1,40,2,180,0.15,15)
OR3_KitchenExhaustFan.windows([1140,1380],[300,420],0.2)
...
OR3_RiceCooker.windows([1200,1380],[0,0],0.3)
