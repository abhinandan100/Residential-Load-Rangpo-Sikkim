...
OR_SetTopBox = OR.Appliance(OR,2,10,2,180,0.15,15)
...
OR_BathroomGeyser = OR.Appliance(OR,2,2000,2,60,0.1,15, 'yes',1, occasional_use=0.75)
OR_BathroomGeyser.windows([300,420],[0,0],0.1)
OR_BathroomGeyser.specific_cycle_1(2000,10,10,5)
OR_BathroomGeyser.cycle_behaviour([300,420],[0,0])
...
OR3_BathroomGeyser = OR3.Appliance(OR,1,2000,2,60,0.1,15, 'yes',1, occasional_use=0.5)
OR3_BathroomGeyser.windows([1080,1140],[360,540],0.1)
